...
def launch_setup(context, *args, **kwargs):
    ...
    moveit_config = (
        ...
        .robot_description(
            file_path=get_package_share_directory("kuka_agilus_support")
    ...
    startup_launch = IncludeLaunchDescription(
        ...
        launch_arguments={"client_ip":"172.32.1.100"}.items()
    )
...
def generate_launch_description():
    launch_arguments = []
    launch_arguments.append(DeclareLaunchArgument("robot_model", default_value="kr4_r600"))
